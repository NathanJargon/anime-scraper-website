    ...
    if ($("#oldCarousel").length == 0) {
        ...
        $("body").append(`
            ...
            <div class="carousel-inner" style="max-height: 250px;">
                ...
                <img src="b.png" class="d-block w-100 img-fluid rounded" alt="...">
                ...
                <img src="d.png" class="d-block w-100 img-fluid rounded" alt="...">
                <div class="carousel-caption d-md-block">
                ...
                <div class="carousel-item">
                <img src="a.png" class="d-block w-100 img-fluid rounded" alt="...">
                <div class="carousel-caption d-md-block">
...
function showNewCarousel() {
    ...
    if ($("#newCarousel").length == 0) {
        ...
        <div class="carousel-item active">
            ...
            <img src="b.png" class="d-block w-50 img-fluid rounded" alt="...">
            </div>
        </div>
        <div class="carousel-item">
            <div class="d-flex justify-content-between align-items-start">
            ...
            <img src="a.png" class="d-block w-50 img-fluid rounded" alt="...">
            </div>
        </div>
        <div class="carousel-item">
            <div class="d-flex justify-content-between align-items-start">
            ...
            <img src="d.png" class="d-block w-50 img-fluid rounded" alt="...">
            </div>
        </div>
